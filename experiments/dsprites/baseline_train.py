...
from experiments.dsprites.input_pipeline import build_input_queue
from experiments.dsprites.model_pipeline import build_criterion
from experiments.dsprites.model_pipeline import build_model
...
parser.add_argument("--experiment_name", type=str, default="hypervae-dsprites-train")
