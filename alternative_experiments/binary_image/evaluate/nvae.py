...
def main():
  ...
  # )
  #
  rate, dist = get_hyper_rd(ENTITY, HYPER_NAME, "3onoyfil")
  plt.plot(rate, dist, "o-", label="$a = 0.001$", linewidth=1.5, alpha=0.8)
  rate, dist = get_hyper_rd(ENTITY, HYPER_NAME, "2hi895qr")
  plt.plot(rate, dist, "o-", label="$a = 0.01$", linewidth=1.5, alpha=0.8)
  rate, dist = get_hyper_rd(ENTITY, HYPER_NAME, "1elbwxph")
  plt.plot(rate, dist, "o-", label="$a = 0.1$", linewidth=1.5, alpha=0.8)
  rate, dist = get_hyper_rd(ENTITY, HYPER_NAME, "2ot8ob4x")
  plt.plot(rate, dist, "o-", label="$a = 1$", linewidth=1.5, alpha=0.8)
  ...
  plt.tight_layout()
  plt.savefig("init_range_omniglot.pdf", bbox_inches="tight")
  plt.show()
