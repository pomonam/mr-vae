...
import math
from alternative_experiments.text.models import LstmDecoder, LstmEncoder
from alternative_experiments.text.old_version.hyper.vae import HyperVae
from alternative_experiments.text.old_version.models.samplers import IsotropicGaussianSampler
from alternative_experiments.text.old_version.models.vae import BaseVae
from alternative_experiments.text.old_version.criterions import kl_gaussian, log_sum_exp

from alternative_experiments.text.hyper_models import HyperLstmDecoder, HyperLstmEncoder
from alternative_experiments.text.old_version.hyper.models import HyperIsotropicGaussianSampler
...
def build_hyper_model(name, hyper_config, device):
    ...
    sampler = HyperIsotropicGaussianSampler(nh=1024, nz=32)
