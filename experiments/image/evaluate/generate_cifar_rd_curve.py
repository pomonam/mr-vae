...
ENTITY = "bae-group"
BASELINE_NAME = "hypervae_image_train_v2"
HYPER_NAME = "hypervae_image_hyper_train_v1"
ID = "11hrzp1i"
DATA_NAME = "cifar"
...
def main():
  ...
  plt.plot([0], [0])
  plt.scatter(rate, dist, label=r"Independent Training",
  ...
  plt.title("Rate-Distortion Curve for CIFAR")
  plt.legend()
  plt.grid()
  plt.show()
