...
import os
import urllib
from experiments.nvae.lmdb_datasets import LMDBDataset
from experiments.nvae.thirdparty.lsun import LSUN
...
def get_loaders_eval(dataset, args):
    ...
    if dataset == 'cifar10':
        ...
        if dataset == 'celeba_64':
            ...
            train_data = dset.CelebA(root=args.data, split="train", transform=train_transform)
            valid_data = dset.CelebA(root=args.data, split="test", transform=valid_transform)
