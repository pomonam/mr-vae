...
from experiments.text_legacy.old_version.config import HyperConfig
...
class HyperIsotropicGaussianSampler(BaseSampler):
    ...
    def __init__(self, nh: int, nz: int, hyper_config: HyperConfig) -> None:
        ...
        self.mean_proj = HyperLinear(self.nh, self.nz, "none", hyper_config)
        self.log_var_proj = HyperLinear(self.nh, self.nz, "none", hyper_config)
    ...
    def forward(self, x: torch.Tensor) -> dict:
        ...
        log_var = self.log_var_proj(log_var)
