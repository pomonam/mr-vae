...
from experiments.b_mnist_cnn.input_pipeline import build_input_queue
from experiments.b_mnist_cnn.model_pipeline import build_criterion
from experiments.b_mnist_cnn.model_pipeline import build_model
...
parser.add_argument("--experiment_name", type=str, default="hyper_vae-b_mnist_cnn")
