...
def load_data(name, split, batch_size, data_path="../../logs/text_data"):
  ...
  train_data = MonoTextData(
      os.path.join(data_path, file_name + "train.txt"), label=label)
  vocab = train_data.vocab
  valid_data = MonoTextData(
      os.path.join(data_path, file_name + "valid.txt"),
      label=label,
      vocab=vocab)
  test_data = MonoTextData(
      os.path.join(data_path, file_name + "test.txt"), label=label, vocab=vocab)
