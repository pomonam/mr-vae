...
def main(dataset, split, tfr_path, lmdb_path):
  ...
  with env.begin(write=True) as txn:
    for tf_ind in range(num_shards):
      # read tf_record
      tfrecord_path = tfrecord_path_template % (
          split, split, tf_ind, num_shards)
      index_path = None
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      help='dataset name',
      choices=['imagenet-oord_32', 'imagenet-oord_32', 'celeba'])
  parser.add_argument(
      '--tfr_path',
      type=str,
