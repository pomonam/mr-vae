...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='../../logs/data',
    ...
    parser.add_argument('--weight_decay', type=float, default=3e-4,
                        help='weight decay')
    parser.add_argument('--weight_decay_norm', type=float, default=1e-1,
    ...
    # latent variables
    parser.add_argument('--num_latent_scales', type=int, default=3,
                        help='the number of latent scales')
    parser.add_argument('--num_groups_per_scale', type=int, default=20,
