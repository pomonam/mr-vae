...
from alternative_experiments.binary_image.hyper_models import HyperConvDecoder
from alternative_experiments.binary_image.hyper_models import HyperConvEncoder
from alternative_experiments.binary_image.hyper_models import HyperResNetDecoder
from alternative_experiments.binary_image.hyper_models import HyperResNetEncoder
...
def main():
  ...
  parser.add_argument(
      "--experiment_name", type=str, default="ahvae_bimage_debug")
