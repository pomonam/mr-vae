...
OPS = OrderedDict([
    ...
    ('res_bnswish',
     lambda Cin,
     Cout,
     stride: BNSwishConv(Cin, Cout, 3, stride, 1)),
    ('res_bnswish5',
     lambda Cin,
     Cout,
     stride: BNSwishConv(Cin, Cout, 3, stride, 2, 2)),
    ('mconv_e6k5g0',
     lambda Cin,
     Cout,
...
class Conv2D(nn.Conv2d):
  ...
  def __init__(self,
    ...
    """
        ...
        """
    super(Conv2D, self).__init__(C_in,
                                 C_out,
                                 kernel_size,
                                 stride,
                                 padding,
...
class EncCombinerCell(nn.Module):
  ...
  def __init__(self, Cin1, Cin2, Cout, cell_type, hyper_cfg):
