...
from alternative_experiments.text.old_version.hyper.layers.scale import HyperScale
from alternative_experiments.text.old_version.hyper.layers.linear import HyperLinear
from alternative_experiments.text.old_version.hyper.models import BaseHyperEncoder
from alternative_experiments.text.old_version.hyper.models import BaseHyperDecoder
...
class HyperLstmDecoder(BaseHyperDecoder):
    ...
    def __init__(self, vocab_size, ni, nh, nz, hyper_config):
        ...
        self.trans_linear = HyperLinear(nz, nh)
    ...
    def special_decode(self, input, z):
        ...
        # self.lstm.weight_hh_l0 = self.lstm.weight_hh_l0.unsqueeze(0).repeat(32, 1, 1)
